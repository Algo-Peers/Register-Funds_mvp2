      ...
      case 'address':
        return {
          ...
          fields: [
            ...
            { label: 'Digital Address', value: profile?.digitalAddress || '', key: 'digitalAddress' },
            { label: 'Town/City', value: profile?.townCity || '', key: 'townCity' },
            { label: 'District/Region', value: profile?.districtRegion || '', key: 'districtRegion' }
          ]
        };
      case 'contact':
        return {
          ...
          fields: [
            ...
            { label: 'Phone', value: profile?.contactPhone || '', key: 'contactPhone', type: 'tel' as const },
            { label: 'Postal Address', value: profile?.postalAddress || '', key: 'postalAddress' }
          ]
        };
      default:
        return { title: '', fields: [] };
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div>
            ...
            <p className="text-white">{profile?.addressLine1 || 'Not set'}</p>
          </div>
          <div>
            <p className="text-green-400 text-sm mb-2">Address Line 2</p>
            <p className="text-white">{profile?.addressLine2 || 'Not set'}</p>
          </div>
          <div>
            <p className="text-green-400 text-sm mb-2">Digital Address</p>
            <p className="text-white">{profile?.digitalAddress || 'Not set'}</p>
          </div>
          <div>
            <p className="text-green-400 text-sm mb-2">Town/City</p>
            <p className="text-white">{profile?.townCity || 'Not set'}</p>
          </div>
          <div>
            <p className="text-green-400 text-sm mb-2">District/Region</p>
            <p className="text-white">{profile?.districtRegion || 'Not set'}</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="text-white">
              {profile?.contactPhone ? 
                formatPhoneWithCountryCode(profile.contactPhone, profile.country || 'Ghana') : 
                'Not set'
              }
            </p>
          </div>
          <div>
            ...
            <p className="text-white">{profile?.postalAddress || 'Not set'}</p>
          </div>
        </div>
      </motion.div>
